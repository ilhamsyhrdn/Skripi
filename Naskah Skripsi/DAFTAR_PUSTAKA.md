...
Al-Yasriy, H. F. (2020). *The IQ-OTHNCCD lung cancer dataset* [Dataset]. Kaggle. https://www.kaggle.com/datasets/hamdallak/the-iqothnccd-lung-cancer-dataset
...
Das, S. (2021). *IQ-OTHNCCD lung cancer dataset (augmented)* [Dataset]. Kaggle. https://www.kaggle.com/datasets/subhajeetdas/lung-cancer-dataset

Hany, M. (2021). *Chest CT-scan images dataset* [Dataset]. Kaggle. https://www.kaggle.com/datasets/mohamedhanyyy/chest-ctscan-images

He, K., Zhang, X., Ren, S., & Sun, J. (2016). Deep residual learning for image recognition. *2016 IEEE Conference on Computer Vision and Pattern Recognition (CVPR)*, 770–778. https://doi.org/10.1109/CVPR.2016.90

Hennes, W. N. (2021). *Lung cancer dataset (IQ-OTHNCCD)* [Dataset]. Kaggle. https://www.kaggle.com/datasets/waseemnagahhenes/lung-cancer-dataset
...
Rathi, D. (2021). *CT scan images for lung cancer* [Dataset]. Kaggle. https://www.kaggle.com/datasets/dishantrathi20/ct-scan-images-for-lung-cancer
...
Zhang, G., Jiang, S., Yang, Z., Gong, L., Ma, X., Zhou, Z., Bao, C., & Liu, Q. (2022). Re-thinking and re-labeling LIDC-IDRI for robust pulmonary cancer prediction. In *Machine Learning in Medical Imaging (MLMI 2022), Lecture Notes in Computer Science* (Vol. 13583). Springer. https://doi.org/10.48550/arXiv.2207.14238
