...
IN_CSV = Path("D:/skripsi/Kodingan/outputs/manifests/lidc_canonical_pool_final.csv")
TEST_CSV = Path("D:/skripsi/Kodingan/outputs/manifests/test_holdout_final.csv")
TRAINVAL_CSV = Path("D:/skripsi/Kodingan/outputs/manifests/trainval_folds_final.csv")
N_FOLDS = 5
TEST_FRAC = 0.18
SEED = 42
